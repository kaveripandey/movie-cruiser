...
public class AuthorizationController {
    ...
    public ResponseEntity<AuthenticationResponse> createAuthorizationToken(@ApiParam (name = "customerLoginCredentials", value = "Login credentials of the Customer")@RequestBody AuthenticationRequest authenticationRequest) throws LoginException { 
