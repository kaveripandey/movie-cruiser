...
class AuthorizationControllerTest {
	...
	void testValidLogin() throws LoginException {
		AuthenticationRequest authenticationRequest = new AuthenticationRequest("adyasha1", "adyasha1","admin");
	...
	void testInvalidLogin() {
		AuthenticationRequest authenticationRequest = new AuthenticationRequest("adyasha1", "abhishek2","admin");
